...
Do NOT upload this txt file. site.js is now UPDATED too (theme toggle) — upload it.

Optional cleanup: delete v1.html from the repo (robots.txt now blocks it anyway).

WHAT CHANGED
- Light/dark theme toggle (moon/sun pill in nav) — light mode default: #D6D7D7 base, #F5F5F5 cards, #212431 text; dark mode flips to #212431 base. Remembers visitor choice, respects system preference.
